...
You can also do footnotes^[like this], insert images, and hyperlinks. 
...
You probably noticed that we could insert an image using markdown syntax. It is likely also noticed that the result is just a hunk of an image and you had very little control over how it displays. I prefer to use `include_graphics()` from the `knitr` package.
